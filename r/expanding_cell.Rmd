...
#' @param N The number of times to sub-divide the largest cell. I.e. if N=20 then the smallest grid at which error is calculated will be 20*20 cells.
#'
...
msea <- function(points1, points2, N=20) {
